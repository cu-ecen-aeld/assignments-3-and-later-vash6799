...
* @return a pointer to the overwritten buffer string if the buffer was full, or NULL if it was not full.
*/
const char *aesd_circular_buffer_add_entry(struct aesd_circular_buffer *buffer, const struct aesd_buffer_entry *add_entry)
{
    ...
    /* If already full, we are about to overwrite the oldest entry. */
    /* We must save its pointer to return it, then advance out_offs */
    if (buffer->full) {
